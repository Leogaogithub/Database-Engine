...
public class MakeInformationSchema {
	public static void main(String[] args) {
		try {
			...
			RandomAccessFile schemataTableFile = new RandomAccessFile(rootPath +"information_schema.schemata.tbl", "rw");
			RandomAccessFile tablesTableFile = new RandomAccessFile(rootPath +"information_schema.table.tbl", "rw");
			RandomAccessFile columnsTableFile = new RandomAccessFile(rootPath +"information_schema.columns.tbl", "rw");
